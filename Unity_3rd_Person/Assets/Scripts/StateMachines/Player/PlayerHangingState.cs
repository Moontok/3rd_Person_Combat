...
{
    private readonly int HangingHash = Animator.StringToHash("hanging_ledge_idle");

    private const float CrossFadeDuration = 0.1f;

    private Vector3 closestPoint = Vector3.zero;
    private Vector3 ledgeForward = Vector3.zero;
    ...
    public override void Enter()
    {
        ...
        Vector3 handPosition = stateMachine.LedgeDetector.HangPoint.position - stateMachine.transform.position;
        
        stateMachine.transform.position = closestPoint - handPosition;
